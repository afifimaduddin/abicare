...
<body class="hold-transition skin-green sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="{{ url('halamanpasien') }}" class="logo">
            ...
            <ul class="timeline">
              ...
              <li>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Menu "Pilih Layanan"</a></h3>

                  <div class="timeline-body">
                    Pada halaman pilih layanan terdapat beberapa layanan yang bisa dipilih pasien sesuai kebutuhan
                  </div>
                  <div class="timeline-footer">
                    <a href="{{url('/halamanpesan')}}">
                      <button type="submit" class="btn btn-primary btn-xs">pilih layanan</button> 
                    </a>  
                  </div>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">Pilih Homecare</a></h3>
