...
ddsmoothmenu.init({
      ...
      <div class="container templatemo_container">
        <div class="row">
          <div class="col-sm-3 col-md-3">
            <div class="logo">
              <a href="#"><img src="{{url('asset/dist/img/abicarelogo.png')}}"></a>
            </div>
          </div>
  ...
  <div class="container">
      <div class="col-xs-6 col-sm-4 col-md-3 templatemo_col12">
